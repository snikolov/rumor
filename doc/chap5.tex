...
%%% Simplified Analysis of Parameters.
Gamma
up everywhere
* Bottom: up
* Center: up
...
\vt{CmprWindow}
\vt{DetectionWindowHrs}
\vt{WSmooth}

Conclude that \vt{Wmooth} has no noticeable effect regardless of other params.
Conclude that \vt{CmprWindow} has ...
Conclude that \vt{DetectionWindowHrs} has ... 
...
\begin{comment}
\clearpage
%%%%%%%%%%%%%%%%%%%%%% Secondary Effect Gamma
\subsubsection{Secondary Effects for a Variable \vt{Gamma}}

\begin{figure}[!h]
\begin{center}
\includegraphics[width=6in]{../fig/final/delta_hist_sec/gamma/cmpr_window}
\includegraphics[width=5.5in]{../fig/final/position/all_allowed/gamma/cmpr_window}
\end{center}
\caption{\label{fig:delta_sec6} Secondary effects of \vt{CmprWindow} for
  variable parameter \vt{Gamma}}
\end{figure}

\begin{figure}[!h]
\begin{center}
\includegraphics[width=6in]{../fig/final/delta_hist_sec/gamma/threshold}
\includegraphics[width=5.5in]{../fig/final/position/all_allowed/gamma/threshold}
\end{center}
\caption{\label{fig:delta_sec6} Secondary effects of \vt{Threshold} for
  variable parameter \vt{Gamma}}
\end{figure}
...
\includegraphics[width=5.5in]{../fig/final/position/all_allowed/gamma/w_smooth}
\end{center}
\caption{\label{fig:delta_sec6} Secondary effects of \vt{WSmooth} for
  variable parameter \vt{Gamma}}
\end{figure}
...
\includegraphics[width=5.5in]{../fig/final/position/all_allowed/gamma/detection_window_hrs}
\end{center}
\caption{\label{fig:sec} Secondary effects of \vt{DetectionWindowHrs} for variable
  parameter \vt{Gamma}}
\end{figure}
...
\includegraphics[width=5.5in]{../fig/final/position/all_allowed/gamma/req_consec_detections}
\end{center}
\caption{\label{fig:delta_sec6} Secondary effects of \vt{Gamma} for
  variable parameter \vt{Gamma}}
\end{figure}
...
\clearpage
%%%%%%%%%%%%%%%%%%%%%% Secondary Effect CmprWindow
\subsubsection{Secondary Effects for a Variable \vt{CmprWindow}}
...
\end{center}
\caption{\label{fig:delta_sec6} Secondary effects of \vt{Gamma} for
  variable parameter \vt{CmprWindow}}
\end{figure}
...
\begin{comment}
\clearpage
%%%%%%%%%%% Secondary Effect Threshold
\subsubsection{Secondary Effects for a Variable \vt{Threshold}}

\begin{figure}[!h]
\begin{center}
\includegraphics[width=6in]{../fig/final/delta_hist_sec/threshold/gamma}
\includegraphics[width=5.5in]{../fig/final/position/all_allowed/threshold/gamma}
\end{center}
\caption{\label{fig:delta_sec6} Secondary effects of \vt{Gamma} for
  variable parameter \vt{Threshold}}
\end{figure}

\begin{figure}[!h]
\begin{center}
\includegraphics[width=6in]{../fig/final/delta_hist_sec/threshold/cmpr_window}
\includegraphics[width=5.5in]{../fig/final/position/all_allowed/threshold/cmpr_window}
\end{center}
\caption{\label{fig:delta_sec6} Secondary effects of \vt{CmprWindow} for
  variable parameter \vt{Threshold}}
\end{figure}
...
\includegraphics[width=5.5in]{../fig/final/position/all_allowed/threshold/w_smooth}
\end{center}
\caption{\label{fig:delta_sec6} Secondary effects of \vt{WSmooth} for
  variable parameter \vt{Threshold}}
\end{figure}
...
\includegraphics[width=5.5in]{../fig/final/position/all_allowed/threshold/detection_window_hrs}
\end{center}
\caption{\label{fig:sec} Secondary effects of \vt{DetectionWindowHrs} for variable
  parameter \vt{Threshold}}
\end{figure}

\begin{figure}[!h]
\begin{center}
  \includegraphics[width=6in]{../fig/final/delta_hist_sec/threshold/req_consec_detections}
\includegraphics[width=5.5in]{../fig/final/position/all_allowed/threshold/req_consec_detections}
\end{center}
\caption{\label{fig:delta_sec6} Secondary effects of \vt{ReqConsecDetections} for
  variable parameter \vt{Threshold}}
\end{figure}
...
\clearpage
%%%%%%%%%%% Secondary effects WSmooth
\subsubsection{Secondary Effects for a Variable \vt{WSmooth}}
...
\end{center}
\caption{\label{fig:delta_sec6} Secondary effects of \vt{DetectionWindowHrs} for
  variable parameter \vt{WSmooth}}
\end{figure}
...
\end{center}
\caption{\label{fig:sec} Secondary effects of \vt{ReqConsecDetections} for variable
  parameter \vt{WSmooth}}
\end{figure}


\clearpage
%%%%%%%%%%% Secondary effects DetectionWindowHrs
\subsubsection{Secondary Effects for a Variable \vt{DetectionWindowHrs}}
...
\end{center}
\caption{\label{fig:delta_sec6} Secondary effects of \vt{Gamma} for
  variable parameter \vt{DetectionWindowHrs}}
\end{figure}
...
\end{center}
\caption{\label{fig:sec} Secondary effects of \vt{ReqConsecDetections} for variable
  parameter \vt{DetectionWindowHrs}}
\end{figure}
...
\clearpage
%%%%%%%%%%% ReqConsecDetections
\subsubsection{Secondary Effects for a Variable \vt{ReqConsecDetections}}

\begin{figure}[!h]
\begin{center}
\includegraphics[width=6in]{../fig/final/delta_hist_sec/req_consec_detections/gamma}
\includegraphics[width=5.5in]{../fig/final/position/all_allowed/req_consec_detections/gamma}
\end{center}
\caption{\label{fig:delta_sec6} Secondary effects of \vt{Gamma} for
  variable parameter \vt{ReqConsecDetections}}
\end{figure}

\begin{figure}[!h]
\begin{center}
\includegraphics[width=6in]{../fig/final/delta_hist_sec/req_consec_detections/cmpr_window}
\includegraphics[width=5.5in]{../fig/final/position/all_allowed/req_consec_detections/cmpr_window}
\end{center}
\caption{\label{fig:delta_sec6} Secondary effects of \vt{CmprWindow} for
  variable parameter \vt{ReqConsecDetections}}
\end{figure}
...
\begin{figure}[!h]
\begin{center}
\includegraphics[width=6in]{../fig/final/delta_hist_sec/req_consec_detections/threshold}
\includegraphics[width=5.5in]{../fig/final/position/all_allowed/req_consec_detections/threshold}
\end{center}
\caption{\label{fig:delta_sec6} Secondary effects of \vt{Threshold} for
  variable parameter \vt{ReqConsecDetections}}
\end{figure}
...
\begin{figure}[!h]
\begin{center}
\includegraphics[width=6in]{../fig/final/delta_hist_sec/req_consec_detections/w_smooth}
\includegraphics[width=5.5in]{../fig/final/position/all_allowed/req_consec_detections/w_smooth}
\end{center}
\caption{\label{fig:delta_sec6} Secondary effects of \vt{WSmooth} for
  variable parameter \vt{ReqConsecDetections}}
\end{figure}
...
\begin{figure}[!h]
\begin{center}
\includegraphics[width=6in]{../fig/final/delta_hist_sec/req_consec_detections/detection_window_hrs}
\includegraphics[width=5.5in]{../fig/final/position/all_allowed/req_consec_detections/detection_window_hrs}
\end{center}
\caption{\label{fig:sec} Secondary effects of \vt{DetectionWindowHrs} for variable
  parameter \vt{ReqConsecDetections}}
\end{figure}

\end{comment}

Analysis: There's a lot of variation from a few params so it's hard to tell what the other params are doing. The direction stuff moves along the curve is also largely influenced by where is starts out along the curve.
...
%on fpr). Show many (ranked) thumbnail ROC curves for each variable parameter.
...
%ROC curves for each variable parameter.
